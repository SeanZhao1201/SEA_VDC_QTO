...
namespace QTO_Tool
{
    class ContinuousFootingTemplate
    {
        ...
        void SidesAndEndAndOpeingArea()
        {
            ...
            if (!lengthMeasured)
            {
                throw new InvalidOperationException("ContinuousFootingTemplate: no top face intersects the reconstructed centerline; length cannot be measured.");
            }
        ...
        double GrossVolume()
        {
            ...
            {
                Logger.Warn("ContinuousFootingTemplate: gross volume fell back to net volume for object " + this.id + " (classified faces could not be rejoined).");
            ...
            if (mass_properties == null)
            {
                Logger.Warn("ContinuousFootingTemplate: gross volume fell back to net volume for object " + this.id + " (gross volume not computable).");
