...
namespace QTO_Tool
{
    class CurbTemplate
    {
        ...
        void SidesAndEndAndOpeingArea()
        {
            ...
            if (!lengthMeasured)
            {
                throw new InvalidOperationException("CurbTemplate: no top face intersects the reconstructed centerline; length cannot be measured.");
            }
        ...
        double GrossVolume()
        {
            ...
            {
                Logger.Warn("CurbTemplate: gross volume fell back to net volume for object " + this.id + " (classified faces could not be rejoined).");
            ...
            if (mass_properties == null)
            {
                Logger.Warn("CurbTemplate: gross volume fell back to net volume for object " + this.id + " (gross volume not computable).");
