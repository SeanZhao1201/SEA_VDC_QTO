...
namespace QTO_Tool
{
    class WallTemplate
    {
        ...
        void SidesAndEndAndOpeingArea()
        {
            ...
            if (!lengthMeasured)
            {
                throw new InvalidOperationException("WallTemplate: no top face intersects the reconstructed centerline; length cannot be measured.");
            }
        ...
        double GrossVolume()
        {
            ...
            {
                Logger.Warn("WallTemplate: gross volume fell back to net volume for object " + this.id + " (classified faces could not be rejoined).");
            ...
            if (mass_properties == null)
            {
                Logger.Warn("WallTemplate: gross volume fell back to net volume for object " + this.id + " (gross volume not computable).");
